...
import { polybotWorkerInjection } from "https://cdn.polymodloader.com/gh/michael201110/poly-bot/v0.1.22/pml-mod/0.1.0/worker_runtime.js";
      ...
      worker.addEventListener("message", (event) => {
        if (
          (event.data?.polybotAbortRestart !== true &&
            event.data?.polybotPlayerFinished !== true) || restartScheduled
        ) return;
        restartScheduled = true;
        setTimeout(() => { pressBackspace(); restartScheduled = false; }, 500);
      });
      return worker;
    };
