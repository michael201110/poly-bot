...
import { polybotWorkerInjection } from "https://cdn.polymodloader.com/gh/michael201110/poly-bot/v0.1.7/pml-mod/0.1.0/worker_runtime.js";
...
class PolyBotBridgeMod extends PolyMod {
  ...
  preInit = (pml) => {
    ...
    // setCarState's native reset branch already clears interpolation and
    // camera state. Recreate its private control recorder there as well so a
    // genuine frame-zero reset is valid and the visible timer can restart.
    pml.registerGlobalMixin({
      type: MixinType.INSERT,
