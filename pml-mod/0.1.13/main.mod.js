...
import { polybotWorkerInjection } from "https://cdn.polymodloader.com/gh/michael201110/poly-bot/v0.1.13/pml-mod/0.1.0/worker_runtime.js";
  ...
  preInit = (pml) => {
    ...
    globalThis.__polybotWrapSimulationWorker = (worker) => {
      ...
      worker.addEventListener("message", (event) => {
        if (event.data?.polybotPlayerFinished !== true || restartScheduled) {
          return;
        }
